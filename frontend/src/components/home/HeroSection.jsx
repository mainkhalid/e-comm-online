    ...
    >
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            "linear-gradient(to bottom, rgba(0,0,0,0.55) 0%, rgba(0,0,0,0) 35%, rgba(0,0,0,0) 40%, rgba(0,0,0,0.72) 70%, rgba(0,0,0,0.92) 100%)",
        }}
      />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 divide-y sm:divide-y-0 lg:divide-x divide-gray-100">
            {TRUST.map(({ label, sub }, i) => (
              <div
                key={label}
                className="flex items-start gap-3 py-5 px-4 sm:px-6 transition-colors hover:bg-gray-50/50"
              >
                {/* Index Counter Indicator */}
                <span className="text-xs font-bold font-mono tracking-wider text-amber-600 opacity-60 pt-0.5 select-none">
                  0{i + 1}.
                </span>
                ...
                <div className="space-y-0.5">
                  ...
                  <p className="text-xs text-gray-500 leading-normal">{sub}</p>
                </div>
              </div>
            ))}
          </div>
